...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_BC3F3645_DA56_45A3_B200_D8C32469A780 START WITH 101 BELONGS_TO_TABLE;  
...
CREATE CACHED TABLE PUBLIC.USER_DETAILS(
    USER_ID INT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_BC3F3645_DA56_45A3_B200_D8C32469A780) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_BC3F3645_DA56_45A3_B200_D8C32469A780,
...
ALTER TABLE PUBLIC.USER_DETAILS ADD CONSTRAINT PUBLIC.CONSTRAINT_3E PRIMARY KEY(USER_ID);     
-- 100 +/- SELECT COUNT(*) FROM PUBLIC.USER_DETAILS;          
